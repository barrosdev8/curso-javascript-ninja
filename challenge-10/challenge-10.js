...
*/
operationSignal = '+';
var sum = calcutator( operationSignal );
...
*/
operationSignal = '-';
var subtraction = calcutator( operationSignal );
...
var multiplication = calcutator( operationSignal );
...
var division = division = calcutator( operationSignal );
...
operationSignal = '%';
var mod = calcutator( operationSignal );
...
var dot = calcutator( operationSignal );
...
if( dot ){
    ...
    console.log(showOperationMessage( operationSignal, number1, number2 ), dot( number1, number2 ));
