(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Lucas Barros'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'aparecidense'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(matched){
    ...
    */
    ...
    function getMonthNumber(month){
        switch(month){
            ...
            default:
                return 'Favor inserir um mês válido, por exemplo: "dezembro".'
        } // usando objeto é bem mais fácil e simples.
    }
