...
var $inputUsername = doc.getSelection('input[type="text"]');
...
function isValidEmail(email){
    const regex = /^[+\w.]+@\w+\.\w{2,}(?:\.\w{2})?$/g;
    //console.log(email +" - " + regex.test(email)); Teste
...
console.log(arr.forEach(isValidEmail)); Teste*/
